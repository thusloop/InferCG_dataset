...
project_name_list = project_name_list_1 + project_name_list_2
replace_list = [
    ('<**PyList**>','<list>'),
    ("<**PyStr**>","<str>"),
    ("<**PyDict**>","<map>"),
...
def main():
    ...
    try:
        merged_file_path = r'E:\001_some_AI_code\003_AutoExtension\src\Archive\qwen-max\data\merged_data.csv'
        df_merged = pd.read_csv(merged_file_path, header=None, encoding='utf-8')
    ...
    df_out.to_csv('test_dataset.csv', index=False, encoding='utf-8-sig', quoting=csv.QUOTE_ALL)
